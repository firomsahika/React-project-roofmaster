...
const Home = () => {
  ...
  return (
    <div style={myStyle} className='bg-cover h-80'>
      ...
      <div className='hidden md:flex justify-end px-4 sm:px-8 md:px-16 lg:px-32'>
        <nav className='h-20 flex items-center justify-center text-white'>
          <ul className='flex gap-4 sm:gap-8 font-semibold'>
          <li>
                <NavLink to="/" style={navColor}  >
                    Home
                  </NavLink>
      ...
      <div className='flex items-center justify-center'>
        <p
          data-aos='zoom-in'
          className='text-3xl sm:text-4xl lg:text-5xl text-white font-bold pt-20'
        >
          About Us
        </p>
      </div>
